...
export function Footer() {
  return (
    <footer className="border-t border-dlv-border dark:border-dlv-dark-border bg-white dark:bg-dlv-dark-card transition-colors">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-semibold text-gray-900 dark:text-gray-100">DeepLV</span>
            </div>
          ...
          <div>
            <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-3 text-sm">Product</h3>
            <ul className="space-y-2">
              <li><Link to="/translate" className="text-sm text-gray-500 dark:text-gray-400 hover:text-dlv-accent">Translator</Link></li>
              <li><Link to="/getting-started" className="text-sm text-gray-500 dark:text-gray-400 hover:text-dlv-accent">Getting Started</Link></li>
              <li><Link to="/api-reference" className="text-sm text-gray-500 dark:text-gray-400 hover:text-dlv-accent">API Reference</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 dark:border-dlv-dark-border text-center text-xs text-gray-400">
